...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\MixController' => 'getMixControllerService',
    ...
    protected function get_Container_Private_ProfilerService()
    {
        ...
        $e->registerClient('githubContentClient', ($this->privates['.debug.githubContentClient'] ?? $this->get_Debug_GithubContentClientService()));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lMgEGET6Bj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.debug.githubContentClient' shared service.
     *
     * @return \Symfony\Component\HttpClient\TraceableHttpClient
     */
    protected function get_Debug_GithubContentClientService()
    {
        return $this->privates['.debug.githubContentClient'] = new \Symfony\Component\HttpClient\TraceableHttpClient(\Symfony\Component\HttpClient\ScopingHttpClient::forBaseUri(($this->privates['.debug.http_client.inner'] ?? $this->get_Debug_HttpClient_InnerService()), 'https://raw.githubusercontent.com', ['headers' => ['Authorization' => 'Token '.$this->getEnv('string:GITHUB_TOKEN')], 'query' => [], 'resolve' => []]), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2AGJsDD-Bw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Cf2TMxOIvg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I+YN8F2rCu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5+XkZhjuAA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fYDJfDNc+w', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['ar' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ar.xliff')], 'bg' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.bg.xliff')], 'bs_Latn_BA' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.bs_Latn_BA.xliff')], 'ca' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ca.xliff')], 'cs' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.cs.xliff')], 'da' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.da.xliff')], 'de' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.de.xliff')], 'en' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.en.xliff')], 'eo' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.eo.xliff')], 'es' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.es.xliff')], 'eu' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.eu.xliff')], 'fi' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.fi.xliff')], 'fr' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.fr.xliff')], 'hr_HR' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.hr_HR.xliff')], 'hu' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.hu.xliff')], 'id' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.id.xliff')], 'it' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.it.xliff')], 'ja' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ja.xliff')], 'ky' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ky.xliff')], 'lt' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.lt.xliff')], 'nb' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.nb.xliff')], 'nl' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.nl.xliff')], 'nn' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.nn.xliff')], 'pl' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pl.xliff')], 'pt' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pt.xliff')], 'pt_BR' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pt_BR.xliff')], 'pt_PT' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.pt_PT.xliff')], 'ro' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ro.xliff')], 'ru' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.ru.xliff')], 'sk' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sk.xliff')], 'sl' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sl.xliff')], 'sr_Latin' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sr_Latin.xliff')], 'sv' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.sv.xliff')], 'th' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.th.xliff')], 'tr' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.tr.xliff')], 'uk' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.uk.xliff')], 'vi' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.vi.xliff')], 'zh' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh.xliff')], 'zh_CN' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh_CN.xliff')], 'zh_HK' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh_HK.xliff')], 'zh_TW' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations/time.zh_TW.xliff')]], 'scanned_directories' => [0 => (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/Resources/translations'), 1 => (\dirname(__DIR__, 4).'/translations'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/translations'), 3 => (\dirname(__DIR__, 4).'/vendor/symfony/twig-bundle/translations'), 4 => (\dirname(__DIR__, 4).'/vendor/twig/extra-bundle/translations'), 5 => (\dirname(__DIR__, 4).'/vendor/symfony/web-profiler-bundle/translations'), 6 => (\dirname(__DIR__, 4).'/vendor/symfony/monolog-bundle/translations'), 7 => (\dirname(__DIR__, 4).'/vendor/symfony/debug-bundle/translations'), 8 => (\dirname(__DIR__, 4).'/vendor/symfony/webpack-encore-bundle/src/translations'), 9 => (\dirname(__DIR__, 4).'/vendor/symfony/ux-turbo/translations'), 10 => (\dirname(__DIR__, 4).'/vendor/symfony/maker-bundle/src/translations'), 11 => (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/translations'), 12 => (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-migrations-bundle/translations')], 'cache_vary' => ['scanned_directories' => [0 => 'vendor/knplabs/knp-time-bundle/Resources/translations', 1 => 'translations', 2 => 'vendor/symfony/framework-bundle/translations', 3 => 'vendor/symfony/twig-bundle/translations', 4 => 'vendor/twig/extra-bundle/translations', 5 => 'vendor/symfony/web-profiler-bundle/translations', 6 => 'vendor/symfony/monolog-bundle/translations', 7 => 'vendor/symfony/debug-bundle/translations', 8 => 'vendor/symfony/webpack-encore-bundle/src/translations', 9 => 'vendor/symfony/ux-turbo/translations', 10 => 'vendor/symfony/maker-bundle/src/translations', 11 => 'vendor/doctrine/doctrine-bundle/translations', 12 => 'vendor/doctrine/doctrine-migrations-bundle/translations']]], []);
